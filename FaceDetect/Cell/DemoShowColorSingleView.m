...
- (void)configureData:(PaletteColorModel*)model andKey:(NSString *)modeKey{
    ...
    if (![model isKindOfClass:[PaletteColorModel class]]){
        ...
        const CGFloat* components1 = CGColorGetComponents([UIColor colorWithHexString:model.imageColorString].CGColor);
        ...
        showText = [NSString stringWithFormat:@"Red-%f\nGreen-%f\nBlue-%f",Red1,Green1,Blue1];
    ...
    _showColorLabel.numberOfLines = 0;
