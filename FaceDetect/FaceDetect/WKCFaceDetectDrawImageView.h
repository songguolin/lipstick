...
/// 画线完成回调
@property (nonatomic, copy) void(^completionBlock)(WKCFaceDetectDrawState state,WKCFaceDetectModel *  faceDetectModel);

/// 注: setImage时自动开始画线
@property (nonatomic,strong) WKCFaceDetectModel *  faceDetectModel;
